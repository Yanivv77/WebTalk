...
export const Message = ({ content, isUserMessage }: MessageProps) => {
  return (
    ...
    >
      <div className="p-6">
        <div className="max-w-3xl mx-auto flex items-start gap">
          <div
            className={cn(
              "size-10 shrink-0 aspect-square rounded-full border border-zinc-700 bg-zinc-900 flex justify-center items-center",
              {
                "bg-slate-950 border-blue-700 text-zinc-200": isUserMessage,
                "bg-blue-900/25 border-blue-700 text-zinc-200": !isUserMessage,
              }
            )}
          >
          ...
          <div className="flex flex-col ml-6 w-full">
            <div className="flex items-center space-x-2">
              <span className="text-sm front-semibold text-gray-900 dark:text-white">{isUserMessage ? "You" : "Website"}</span>
            </div>
